...
class FakeDataDummy {
    ...
    companion object {
        fun generateDummyCourses(): ArrayList<CourseEntity> {
            var courses: ArrayList<CourseEntity> = arrayListOf()
        ...
        fun getCourse(courseId: String): CourseEntity? {
            for (i in 0..generateDummyCourses().size) {
                var entity: CourseEntity = generateDummyCourses()
                    .get(i)

                if (entity.courseId.equals(courseId)) {
                    return entity
                }
            }
            return null
        ...
        fun generateRemoteDummyCourses(): ArrayList<CourseResponse> {
            var courses: ArrayList<CourseResponse> = arrayListOf()
        ...
        fun generateRemoteDummyModules(courseId: String): ArrayList<ModuleResponse> {
            var modules: ArrayList<ModuleResponse> = arrayListOf()
        ...
        fun generateDummyCourseWithModules(
            ...
            courseWithModule.course?.bookmarked = bookmarked
